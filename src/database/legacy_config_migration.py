...
# TODO: Delete these prompt-map conversion helpers when the legacy prompt-map UI
# is removed. They live with the legacy config migration because prompt maps are
# old-data compatibility glue, not a runtime Smart Field persistence abstraction.
